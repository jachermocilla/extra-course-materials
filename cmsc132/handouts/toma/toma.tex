...
to know to make a binary machine language program work correctly. Typically a 
documentation of the \textit{set of instructions that can be performed by the 
...
It allows computer designers to talk about functions indepedently from the 
...
Core i5 product as 8th Generation aka as \textbf{Kaby Lake Refresh}. AMD also 
implements these ISA in the Ryzen 5000 as 4th Gen aka \textbf{Zen 3}. There are 
other implementations that vary in their performance characteristics.

For mobile devices a popular ISA is the \textbf{ARMv8 A64}. MediaTek uses ARM's 
Cortex-A73 and Cortex-A53 implementation in their Helio P70. Qualcomm also uses 
the same implementations in their Kryo 240 Snapdragon SoC.
